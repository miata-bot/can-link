-file("/Users/connor/.asdf/installs/erlang/24.2/lib/parsetools-2.3.2/include/leexinc.hrl", 0).
...
-module(assembler_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/assembler_lexer.xrl", 28).

-file("/Users/connor/.asdf/installs/erlang/24.2/lib/parsetools-2.3.2/include/leexinc.hrl", 14).
...
-file("src/assembler_lexer.erl", 307).
yystate() -> 38.
...
yystate(40, [10|Ics], Line, Tlen, _, _) ->
    yystate(40, Ics, Line+1, Tlen+1, 16, Tlen);
...
yystate(38, [C|Ics], Line, Tlen, Action, Alen) when C >= 79, C =< 82 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(38, [C|Ics], Line, Tlen, Action, Alen) when C >= 84, C =< 90 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
...
yystate(37, [95|Ics], Line, Tlen, _, _) ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
yystate(37, [76|Ics], Line, Tlen, _, _) ->
    yystate(41, Ics, Line, Tlen+1, 12, Tlen);
yystate(37, [74|Ics], Line, Tlen, _, _) ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
...
yystate(37, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 72 ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
yystate(37, [C|Ics], Line, Tlen, _, _) when C >= 77, C =< 90 ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
...
yystate(36, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 70 ->
    yystate(36, Ics, Line, Tlen+1, 0, Tlen);
yystate(36, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 102 ->
    yystate(36, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(35, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 71 ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
yystate(35, [C|Ics], Line, Tlen, _, _) when C >= 73, C =< 90 ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
...
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 83 ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
...
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 75 ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 77, C =< 90 ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
...
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 78 ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 80, C =< 90 ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
...
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 79 ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 81, C =< 90 ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
...
yystate(13, [95|Ics], Line, Tlen, _, _) ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
yystate(13, [67|Ics], Line, Tlen, _, _) ->
    yystate(17, Ics, Line, Tlen+1, 12, Tlen);
yystate(13, [65|Ics], Line, Tlen, _, _) ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
yystate(13, [66|Ics], Line, Tlen, _, _) ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 68, C =< 90 ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
...
yystate(11, [66|Ics], Line, Tlen, _, _) ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
yystate(11, [C|Ics], Line, Tlen, _, _) when C >= 68, C =< 90 ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
...
yystate(1, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 89 ->
    yystate(8, Ics, Line, Tlen+1, 12, Tlen);
...
-file("src/assembler_lexer.xrl", 8).
yyaction_0(TokenChars, TokenLen, TokenLine) ->
     { token, { value, TokenLine, list_to_integer (lists : sublist (TokenChars, 2, TokenLen - 1), 16) } } .

-compile({inline,yyaction_1/2}).
-file("src/assembler_lexer.xrl", 9).
yyaction_1(TokenChars, TokenLine) ->
     { token, { value, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_2/1}).
-file("src/assembler_lexer.xrl", 10).
yyaction_2(TokenLine) ->
     { token, { mnemonic, TokenLine, cls } } .

-compile({inline,yyaction_3/1}).
-file("src/assembler_lexer.xrl", 11).
yyaction_3(TokenLine) ->
     { token, { mnemonic, TokenLine, ld } } .

-compile({inline,yyaction_4/1}).
-file("src/assembler_lexer.xrl", 12).
yyaction_4(TokenLine) ->
     { token, { mnemonic, TokenLine, fill } } .

-compile({inline,yyaction_5/1}).
-file("src/assembler_lexer.xrl", 13).
yyaction_5(TokenLine) ->
     { token, { mnemonic, TokenLine, flush } } .

-compile({inline,yyaction_6/1}).
-file("src/assembler_lexer.xrl", 14).
yyaction_6(TokenLine) ->
     { token, { mnemonic, TokenLine, set } } .

-compile({inline,yyaction_7/1}).
-file("src/assembler_lexer.xrl", 15).
yyaction_7(TokenLine) ->
     { token, { mnemonic, TokenLine, inc } } .

-compile({inline,yyaction_8/1}).
-file("src/assembler_lexer.xrl", 16).
yyaction_8(TokenLine) ->
     { token, { mnemonic, TokenLine, dec } } .

-compile({inline,yyaction_9/1}).
-file("src/assembler_lexer.xrl", 17).
yyaction_9(TokenLine) ->
     { token, { mnemonic, TokenLine, halt } } .

-compile({inline,yyaction_10/1}).
-file("src/assembler_lexer.xrl", 18).
yyaction_10(TokenLine) ->
     { token, { mnemonic, TokenLine, nop } } .

-compile({inline,yyaction_11/1}).
-file("src/assembler_lexer.xrl", 19).
yyaction_11(TokenLine) ->
     { token, { mnemonic, TokenLine, jnz } } .

-compile({inline,yyaction_12/2}).
-file("src/assembler_lexer.xrl", 20).
yyaction_12(TokenChars, TokenLine) ->
     { token, { opperand, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_13/0}).
-file("src/assembler_lexer.xrl", 21).
yyaction_13() ->
     skip_token .

-compile({inline,yyaction_14/3}).
-file("src/assembler_lexer.xrl", 22).
yyaction_14(TokenChars, TokenLen, TokenLine) ->
     { token, { symbol, TokenLine, list_to_atom (lists : sublist (TokenChars, 2, TokenLen - 2)) } } .

-compile({inline,yyaction_15/3}).
-file("src/assembler_lexer.xrl", 23).
yyaction_15(TokenChars, TokenLen, TokenLine) ->
     { token, { address, TokenLine, list_to_atom (lists : sublist (TokenChars, 2, TokenLen - 1)) } } .

-compile({inline,yyaction_16/0}).
-file("src/assembler_lexer.xrl", 24).
yyaction_16() ->
     skip_token .

-file("/Users/connor/.asdf/installs/erlang/24.2/lib/parsetools-2.3.2/include/leexinc.hrl", 313).
